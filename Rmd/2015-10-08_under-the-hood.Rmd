...
### From R to Wordpress
As standard behavior, knit package output and html page which can be viewed in a browser, to complete our publication process we use the Rwordpress package to post directly to our wordpress.
