...
In this third part, we will do some exploratory data analysis and data cleaning of the OurAirports data set we obtained in [part 1](http://chinapleth.io/2015/12/29/getting-and-cleaning-data-example-of-chinese-airports-part-15/)
