...
There are three excellents reference article (with maps of Nepal and Toronto) for such process : 
...
- polygons : a list with as many elements as we have subdivisions (eg. 31 in the case of Chine level 1) with all geographical coordinnates for the subdivisions
...
## Exploring the data 
### Subdivision data
As mentionned previously, this object has two main parts, the data of subdivisions and the polygons.
...
### Polygons
Regarding the plygons, we can plot it quickly :
