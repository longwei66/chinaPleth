...
## Creating one data set and fetching missing data.
...
```{r checkLocation, message=FALSE, fig.width=4, fig.height=4}
...
for(i in 1:nrow(toCheck)){
        p1 <- mapAirport(long = toCheck[i,]$longitude.deg.x, lat = toCheck[i,]$latitude.deg.x, z = 15) + geom_text(aes(x = toCheck[i,]$longitude.deg.x, y = toCheck[i,]$latitude.deg.x, label=paste("OA", toCheck[i,]$IATA.FAA, "-", toCheck[i,]$ICAO)),size = 6, col = "firebrick")
       p2 <- mapAirport(long = toCheck[i,]$longitude.deg.y, lat = toCheck[i,]$latitude.deg.y, z = 15) + geom_text(aes(x = toCheck[i,]$longitude.deg.y, y = toCheck[i,]$latitude.deg.y, label=paste("OF:", toCheck[i,]$IATA.FAA, "-", toCheck[i,]$ICAO)),size = 6, col = "firebrick")
